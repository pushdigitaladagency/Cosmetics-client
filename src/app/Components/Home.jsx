      ...
      <section className="products-section" id="products">
        ...
        <div className="products-grid">
          ...
          <Link href="/category?catcode=cat001" style={{ textDecoration: "none", color: "inherit" }}>
            <div className={`product-card ${activeProduct === "Lip Care" ? "active" : ""}`}
          ...
          <Link href="/category?catcode=cat002" style={{ textDecoration: "none", color: "inherit" }}>
            <div className={`product-card ${activeProduct === "Skin Care" ? "active" : ""}`}
              onMouseLeave={() => setActiveProduct(null)}>
          ...
          <Link href="/category?catcode=cat003" style={{ textDecoration: "none", color: "inherit" }}>
            <div className={`product-card ${activeProduct === "Hair Care" ? "active" : ""}`}
              onMouseLeave={() => setActiveProduct(null)}>
          ...
          <Link href="/category?catcode=cat004" style={{ textDecoration: "none", color: "inherit" }}>
            <div className={`product-card ${activeProduct === "Hygiene" ? "active" : ""}`}
              onMouseLeave={() => setActiveProduct(null)}>
      ...
      <section className="pp">
        ...
        <div className="pp-grid">
          ...
          <div className="pp-card">
            ...
            <div className="pp-img">
              <img
                src="/images/Nourishing-lipbalm.svg"
                alt="body lotion"
              />
            </div>
      ...
      <section className="bn">
        ...
        <div className="bn-left">
          ...
          <div className="bn-btns">
            ...
            <button className="bn-shop">
              Shop Now →
            </button>

            <button className="bn-contact">
              Contact Us
            </button>
